...
🌍 Español (nativo) · Inglés B2 · Francés B1 · Euskera B2
...
- Proyecto con datos confidenciales — código no público

**Stack:** Python · Pandas · Scikit-learn · PySpark · SQL · Dataiku · Power BI

> ℹ️ Para la web: destacar el impacto cuantificable (>50% reducción falsos positivos) y que se trabajó con datos industriales reales. El código es confidencial por acuerdo con Michelin.
...
### Conocimientos básicos (incluir solo si la oferta los pide explícitamente)
- AWS · Docker · REST APIs · React · Next.js
...
- **Movilidad total:** Indicar siempre disponibilidad de cambio de residencia
...
El chatbot del portfolio debe conocer toda esta información y responder de forma natural y profesional. Puntos clave a destacar:
...
- No revelar el teléfono bajo ningún concepto
- Si alguien pregunta por el código del TFG: es confidencial por acuerdo con Michelin
